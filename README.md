...
| 版本 | 日期 | 更新内容 |
|---|---|---|
| v1.3.0 | 2026-06-20 | 修复进入聊天不是最新记录：聊天列表按最后修改时间降序排列 |
...
| v1.2.2 | 2026-06-20 | 聊天页下拉刷新加载历史记录 |
| v1.2.1 | 2026-06-20 | 修复 API Key 存储位置（secrets.json）；服务端测试连接改用 SillyTavern 后端；修复 generate 端点 400 |
| v1.2.0 | 2026-06-20 | 修复对话 HTTP 400 错误；修复聊天记录加载失败；修复输入 KEY 被键盘遮挡；修复服务端 Key 无法删除 |
| v1.1.0 | 2026-06-20 | 服务端 AI 配置增加 DeepSeek 选项；服务端/直连模式均支持测试连接；头像下载鉴权修复；UI 全面美化 |
| v1.0.0 | 2026-06-20 | 初版发布：完整功能转换，6 个页面，服务端模式 + 直连模式 |
